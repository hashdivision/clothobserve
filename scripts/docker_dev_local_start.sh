...
docker run -it -p 127.0.0.1:80:5000 -e CONFIG_OBJECT=configs.config.DevelopmentLocalConfig -e ROOT_PATH=/clothobserve/ -e MONGODB_PORT=27017 -v ${PWD}/clothobserve:/clothobserve clothobserve-dev-local
